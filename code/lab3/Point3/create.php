...
namespace crt;
// Создание списка названий категорий и заготовки для массива $adsDict с объявлениями
$categoriesDir = opendir('categories');
$categoriesNameList = [];
$adsDict = [];  // Ключ — название категории, значение — массив: [название, email, текст]
...
// Добавление объявлений из файлов в массив $adsDict
